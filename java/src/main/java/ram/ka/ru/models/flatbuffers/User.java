...
package ram.ka.ru.models.flatbuffers;
...
public final class User extends Table {
  ...
  public boolean active() { int o = __offset(12); return o != 0 ? 0!=bb.get(o + bb_pos) : false; }
  public String roles(int j) { int o = __offset(14); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int rolesLength() { int o = __offset(14); return o != 0 ? __vector_len(o) : 0; }
  public StringVector rolesVector() { return rolesVector(new StringVector()); }
  public StringVector rolesVector(StringVector obj) { int o = __offset(14); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public double balance() { int o = __offset(16); return o != 0 ? bb.getDouble(o + bb_pos) : 0.0; }
  ...
  public static int createUser(FlatBufferBuilder builder,
    ...
    User.addBalance(builder, balance);
    ...
    User.addActive(builder, active);
    return User.endUser(builder);
  }

  public static void startUser(FlatBufferBuilder builder) { builder.startTable(7); }
  ...
  public static void addActive(FlatBufferBuilder builder, boolean active) { builder.addBoolean(4, active, false); }
  public static void addRoles(FlatBufferBuilder builder, int rolesOffset) { builder.addOffset(5, rolesOffset, 0); }
  ...
  public static void addBalance(FlatBufferBuilder builder, double balance) { builder.addDouble(6, balance, 0.0); }
