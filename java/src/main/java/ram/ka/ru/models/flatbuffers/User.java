...
public final class User extends Table {
    ...
    public StringVector rolesVector() {
        return rolesVector(new StringVector());
    }

    public StringVector rolesVector(StringVector obj) {
        int o = __offset(14);
    ...
    public static void addActive(FlatBufferBuilder builder, boolean active) {
        builder.addBoolean(4, active, false);
    }

    public static void addRoles(FlatBufferBuilder builder, int rolesOffset) {
        builder.addOffset(5, rolesOffset, 0);
    }

    public static int createRolesVector(FlatBufferBuilder builder, int[] data) {
        builder.startVector(4, data.length, 4);
        for (int i = data.length - 1; i >= 0; i--) builder.addOffset(data[i]);
        return builder.endVector();
    }

    public static void startRolesVector(FlatBufferBuilder builder, int numElems) {
        builder.startVector(4, numElems, 4);
    }

    public static void addBalance(FlatBufferBuilder builder, double balance) {
        builder.addDouble(6, balance, 0.0);
    }
    ...
    public static void finishSizePrefixedUserBuffer(FlatBufferBuilder builder, int offset) {
    ...
    public static final class Vector extends BaseVector {
        ...
        public User get(int j) {
            return get(new User(), j);
        }

        public User get(User obj, int j) {
